...
/***/ function(module, exports, __webpack_require__) {
	...
	var _postTemp = __webpack_require__(5);
	...
	var _loadKeyPoints = __webpack_require__(7);
	...
	module.exports = function () {
	  ...
	  (0, _moveKeyPoint2.default)();
	  socketEvent(_keypoint2.default, _moveKeyPoint2.default);
	  (0, _jquery2.default)('#newpost').on('click', helper.alertFn);
	};

	function socketEvent(pointTemplate, moveKeyPoint) {
	  socket.on('change', function (msg) {
	    var ele = (0, _jquery2.default)(".post[data-id='" + msg.tagid + "']");
	    if ((0, _jquery2.default)(ele).length > 0) {
	      console.log('i am here');
	      (0, _jquery2.default)(ele).css({
	        'left': msg.left,
	        'top': msg.top
	      }).find('.header').css('background-color', msg.bgColor);
	      (0, _jquery2.default)(ele).find('.postbody').text(msg.body);
	    } else {
	      (0, _jquery2.default)('#body').prepend((0, _postTemp2.default)(msg));
	      moveKeyPoint();
	    }
	  });
	  socket.on('KPchange', function (data) {
	    (0, _jquery2.default)(".keyPoint[data-id='" + data.tagid + "']").css({
	      'left': data.left
	    }).find('.keyPoinNote').css('top', data.notePosition).find('.nameInfo').text(data.noteContent);
	  });
	  socket.on('delete', function (id) {
	    (0, _jquery2.default)(".post[data-id='" + id + "']").remove();
	  });
	}
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _getData = __webpack_require__(8);
	...
	exports.default = function () {
	  var points = void 0;
	  (0, _getData2.default)('/keypoints', function (data) {
	    points = data;
	    if (points.length) {
	...
	var Post = function () {
		...
		_createClass(Post, [{
			...
			value: function checkUser(ele) {
				...
				return (0, _jquery2.default)(ele).find('.title').text() == value || value == '';
			}
		}, {
			key: 'getPostInfo',
			value: function getPostInfo(ele) {
				var tagid = (0, _jquery2.default)(ele).data('id'),
				    ...
				    body = (0, _jquery2.default)(ele).find('.postbody').text(),
				    left = parseInt((0, _jquery2.default)(ele).css('left')) / (0, _jquery2.default)(document).width() * 100 + '%' || 0,
				    top = parseInt((0, _jquery2.default)(ele).css('top')) / (0, _jquery2.default)(document).height() * 100 + '%' || 0,
			...
			value: function creatPost(e) {
				...
				socket.emit('change', info);
				(0, _postData2.default)('/posts', info);
			}
		}, {
			key: 'newPost',
	...
	var Keypoint = function () {
		...
		_createClass(Keypoint, [{
			...
			value: function getKeyPointInfo(ele) {
				var tagid = (0, _jquery2.default)(ele).data('id'),
				    left = parseInt((0, _jquery2.default)(ele).css('left')) / (0, _jquery2.default)('#keyPointDiv').width() * 100 + '%' || 0,
